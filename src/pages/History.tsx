...
//     return(
//         <div className="flex flex-col px-4 bg-no-repeat bg-cover py-2" style={{ backgroundImage: 'url(/images/spaceX-wallppr.jpg)' }}>
//             <h1 className="text-3xl text-white tracking-widest text-center">History of spaceX</h1>
//             {history.map((history)=>(
//                 <div className="py-4 bg-transparent text-white">
//                     <h1 className="text-2xl font-bold">{history.title}</h1>
//                     <h3>{new Date(history.event_date_utc).toUTCString()}</h3>
//                     <p>{history.details}</p>
//                 </div>
//             ))}
//         </div>
